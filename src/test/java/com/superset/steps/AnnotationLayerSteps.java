...
public class AnnotationLayerSteps {
    ...
    public void iCreateAnAnnotationLayer() {
        ...
        layerData.put("name", "Test Annotation Layer");
    ...
    public void iUpdateAnAnnotationLayer() {
        ...
        Response response = client.put("/api/v1/annotation_layer/1", layerData);
        context.setResponse(response);
    }

    @When("I delete an annotation layer")
    public void iDeleteAnAnnotationLayer() {
        Response response = client.delete("/api/v1/annotation_layer/1");
        context.setResponse(response);
    }

    @When("I request specific annotation layer")
    public void iRequestSpecificAnnotationLayer() {
        Response response = client.get("/api/v1/annotation_layer/1");
        context.setResponse(response);
    }
    ...
    public void iRequestAnnotationsForLayer() {
        Response response = client.get("/api/v1/annotation_layer/1/annotation/");
        context.setResponse(response);
    }
    ...
    public void iCreateAnAnnotation() {
        ...
        Response response = client.post("/api/v1/annotation_layer/1/annotation/", annotationData);
        context.setResponse(response);
    }
    ...
    public void iUpdateAnAnnotation() {
        ...
        Response response = client.put("/api/v1/annotation_layer/1/annotation/1", annotationData);
        context.setResponse(response);
    }

    @When("I delete an annotation")
    public void iDeleteAnAnnotation() {
        Response response = client.delete("/api/v1/annotation_layer/1/annotation/1");
        context.setResponse(response);
    }

    @When("I request specific annotation")
    public void iRequestSpecificAnnotation() {
        Response response = client.get("/api/v1/annotation_layer/1/annotation/1");
        context.setResponse(response);
    }
}
